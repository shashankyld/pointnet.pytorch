...
def DetectMultiPlanes(points, min_ratio=0.1, threshold=0.01, iterations=10):
...
if __name__ == "__main__":
    ...
    # Read pcd
    pcd = o3d.io.read_point_cloud('/home/shashank/Documents/UniBonn/Sem4/Alisha/random sample_filtered/Nr5.pcd')
    # Down sample heavily
    ...
    results = DetectMultiPlanes(points, min_ratio=0.05, threshold=4, iterations=2000)
