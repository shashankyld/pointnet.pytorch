...
# python classify_pc.py --dataset /home/shashank/Documents/UniBonn/Sem4/Alisha/data/dlrvdata --nepoch=4 --model /home/shashank/Documents/UniBonn/Sem4/pointnet.pytorch/utils/seg/seg_model_Chair_3.pth
...
def visualize_point_cloud(points, pred_labels, target_labels=None):
    ...
    for label in unique_labels:
        colors[pred_labels == label] = cmap(label)[:3]
...
for i, data in tqdm(enumerate(testdataloader, 0)):
    ...
    # Save and visualize the first batch
    for i in range(opt.batchSize):
        ...
        visualize_point_cloud(points_np, pred_choice_np)
